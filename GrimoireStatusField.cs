...
namespace Grimoire
{
    public static class GrimoireStatusField
    {
        ...
        static GrimoireStatusField()
        {
            ...
            Berserk =
                NewStatusEffect<BerserkSE_SO>("Berserk_SE", "Berserk_ID")
            ...
            Fury =
                NewStatusEffect<FurySE_SO>("Fury_SE", "Fury_ID")
            ...
            Survive =
                NewStatusEffect<SurviveSE_SO>("Survive_SE", "Survive_ID")
            ...
            Weakened =
                NewStatusEffect<WeakenedSE_SO>("Weakened_SE", "Weakened_ID")
            ...
            Insight =
                NewStatusEffect<InsightSE_SO>("Insight_SE", "Insight_ID")
